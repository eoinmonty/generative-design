...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div6, file$1, 135, 2, 3318);
			attr_dev(div7, "class", "p5-container-bottom-right svelte-12jbszb");
			add_location(div7, file$1, 138, 2, 3402);
		...
		i: function intro(local) {
			...
			if (!div4_intro) {
				add_render_callback(() => {
					div4_intro = create_in_transition(div4, slide, { delay: loadDelay + 500 });
					div4_intro.start();
				});
			}
