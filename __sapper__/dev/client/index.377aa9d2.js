...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-1oohtdu");
			add_location(div0, file$1, 81, 1, 1721);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 88, 2, 2045);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-1oohtdu");
			add_location(a, file$1, 87, 1, 1937);
			attr_dev(div2, "class", "p5-container-top-left svelte-1oohtdu");
			add_location(div2, file$1, 93, 4, 2162);
			attr_dev(div3, "class", "p5-container-top-right svelte-1oohtdu");
			add_location(div3, file$1, 96, 4, 2232);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-1oohtdu");
			add_location(div4, file$1, 99, 4, 2303);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-1oohtdu");
			add_location(div5, file$1, 102, 4, 2376);
			attr_dev(div6, "class", "p5-containers svelte-1oohtdu");
			add_location(div6, file$1, 92, 2, 2130);
			attr_dev(div7, "class", "background-container-right svelte-1oohtdu");
			add_location(div7, file$1, 106, 2, 2457);
			attr_dev(div8, "class", "contents svelte-1oohtdu");
			add_location(div8, file$1, 80, 0, 1697);
		},
		m: function mount(target, anchor) {
