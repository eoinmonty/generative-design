...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-syolen");
			add_location(div0, file$1, 84, 1, 1769);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 91, 2, 2093);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-syolen");
			add_location(a, file$1, 90, 1, 1985);
			attr_dev(div2, "class", "p5-container-top-left svelte-syolen");
			add_location(div2, file$1, 96, 4, 2210);
			attr_dev(div3, "class", "p5-container-top-right svelte-syolen");
			add_location(div3, file$1, 99, 4, 2280);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-syolen");
			add_location(div4, file$1, 102, 4, 2351);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-syolen");
			add_location(div5, file$1, 105, 4, 2424);
			attr_dev(div6, "class", "p5-containers svelte-syolen");
			add_location(div6, file$1, 95, 2, 2178);
			attr_dev(div7, "class", "background-container-right svelte-syolen");
			add_location(div7, file$1, 109, 2, 2505);
			attr_dev(div8, "class", "contents svelte-syolen");
			add_location(div8, file$1, 83, 0, 1745);
		},
		m: function mount(target, anchor) {
