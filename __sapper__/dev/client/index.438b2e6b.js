...
import { c as cubicOut, A as Arrow, s as send, r as receive, a as slideInBounce, b as slideDirection, f as fade, d as fly, e as slide, g as elasticOut, h as backOut } from './Arrow.7a6d2604.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div1, file, 77, 4, 1598);
			attr_dev(div2, "class", "arrow svelte-u40ays");
			add_location(div2, file, 78, 4, 1642);
			...
			add_location(div3, file, 82, 1, 1703);
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!a_intro) a_intro = create_in_transition(a, slide, { x: 100, delay: 2000 });
				a_intro.start();
			});
