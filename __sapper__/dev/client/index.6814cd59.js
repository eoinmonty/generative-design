...
import { c as cubicOut, A as Arrow, s as send, r as receive, a as slideInBounce, b as slideDirection, f as fade, d as fly, e as slide, g as elasticOut, h as backOut } from './Arrow.f83838e1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -1000, delay: 200 }, true);
		...
		o: function outro(local) {
			...
			if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -1000, delay: 200 }, false);
