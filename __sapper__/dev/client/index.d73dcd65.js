...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-wfvolx");
			add_location(div0, file$1, 83, 1, 1659);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 90, 2, 1983);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-wfvolx");
			add_location(a, file$1, 89, 1, 1875);
			attr_dev(div2, "class", "p5-container-top-left svelte-wfvolx");
			add_location(div2, file$1, 94, 2, 2067);
			attr_dev(div3, "class", "p5-container-top-right svelte-wfvolx");
			add_location(div3, file$1, 97, 2, 2131);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-wfvolx");
			add_location(div4, file$1, 100, 2, 2196);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-wfvolx");
			add_location(div5, file$1, 103, 2, 2263);
			attr_dev(div6, "class", "background-container-right svelte-wfvolx");
			add_location(div6, file$1, 106, 1, 2330);
			attr_dev(div7, "class", "intro svelte-wfvolx");
			add_location(div7, file$1, 82, 0, 1638);
		},
		m: function mount(target, anchor) {
