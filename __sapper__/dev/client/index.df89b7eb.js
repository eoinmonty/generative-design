...
import { A as Arrow, f as fade, d as fly, i as scale, e as slide, s as send, r as receive, a as slideInBounce, b as slideDirection, q as quintOut } from './Arrow.a0f9adfc.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		i: function intro(local) {
			...
			if (!div4_intro) {
				add_render_callback(() => {
					div4_intro = create_in_transition(div4, scale, { delay: loadDelay * 2.1 });
					div4_intro.start();
				});
			}
			...
			if (!div5_intro) {
				add_render_callback(() => {
					div5_intro = create_in_transition(div5, scale, { delay: loadDelay * 2.1 });
					div5_intro.start();
				});
			}
			...
			if (!div6_intro) {
				add_render_callback(() => {
					div6_intro = create_in_transition(div6, scale, { delay: loadDelay * 2.1 });
					div6_intro.start();
				});
			}
			...
			if (!div7_intro) {
				add_render_callback(() => {
					div7_intro = create_in_transition(div7, scale, { delay: loadDelay * 2.1 });
					div7_intro.start();
				});
			}
