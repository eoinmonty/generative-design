...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div3, file$1, 125, 2, 3136);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-12jbszb");
			add_location(a, file$1, 124, 1, 3028);
			attr_dev(div4, "class", "p5-container-top-left svelte-12jbszb");
			add_location(div4, file$1, 129, 2, 3220);
		...
		i: function intro(local) {
			...
			if (!div8_intro) {
				add_render_callback(() => {
					div8_intro = create_in_transition(div8, scale, {
						duration: 500,
						delay: 500,
						opacity: 0.5,
						start: 1,
