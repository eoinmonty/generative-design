...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-os577m");
			add_location(div0, file$1, 75, 1, 1522);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 82, 2, 1846);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-os577m");
			add_location(a, file$1, 81, 1, 1738);
			attr_dev(div2, "class", "p5-container-top-left svelte-os577m");
			add_location(div2, file$1, 86, 2, 1930);
			attr_dev(div3, "class", "p5-container-top-right svelte-os577m");
			add_location(div3, file$1, 89, 2, 1994);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-os577m");
			add_location(div4, file$1, 92, 2, 2059);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-os577m");
			add_location(div5, file$1, 95, 2, 2126);
			attr_dev(div6, "class", "background-container-right svelte-os577m");
			add_location(div6, file$1, 98, 1, 2193);
			attr_dev(div7, "class", "contents svelte-os577m");
			add_location(div7, file$1, 74, 0, 1498);
		},
		m: function mount(target, anchor) {
