...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-1awyysx");
			add_location(div0, file$1, 81, 1, 1699);
			attr_dev(div1, "class", "background-container-right svelte-1awyysx");
			add_location(div1, file$1, 87, 1, 1915);
			attr_dev(div2, "class", "background svelte-1awyysx");
			add_location(div2, file$1, 80, 0, 1673);
			attr_dev(div3, "class", "arrow");
			add_location(div3, file$1, 93, 2, 2105);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-1awyysx");
			add_location(a, file$1, 92, 1, 1997);
			attr_dev(div4, "class", "p5-container-top-left svelte-1awyysx");
			add_location(div4, file$1, 97, 2, 2189);
			attr_dev(div5, "class", "p5-container-top-right svelte-1awyysx");
			add_location(div5, file$1, 100, 2, 2253);
			attr_dev(div6, "class", "p5-container-bottom-left svelte-1awyysx");
			add_location(div6, file$1, 103, 2, 2318);
			attr_dev(div7, "class", "p5-container-bottom-right svelte-1awyysx");
			add_location(div7, file$1, 106, 2, 2385);
			attr_dev(div8, "class", "contents svelte-1awyysx");
