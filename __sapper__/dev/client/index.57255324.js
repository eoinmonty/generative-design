...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-1m4jw3o");
			add_location(div0, file$1, 71, 1, 1458);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 78, 2, 1782);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-1m4jw3o");
			add_location(a, file$1, 77, 1, 1674);
			attr_dev(div2, "class", "p5-container-top-left svelte-1m4jw3o");
			add_location(div2, file$1, 82, 2, 1866);
			attr_dev(div3, "class", "p5-container-top-right svelte-1m4jw3o");
			add_location(div3, file$1, 85, 2, 1930);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-1m4jw3o");
			add_location(div4, file$1, 88, 2, 1995);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-1m4jw3o");
			add_location(div5, file$1, 91, 2, 2062);
			attr_dev(div6, "class", "background-container-right svelte-1m4jw3o");
			add_location(div6, file$1, 94, 1, 2129);
			attr_dev(div7, "class", "contents svelte-1m4jw3o");
			add_location(div7, file$1, 70, 0, 1434);
		},
		m: function mount(target, anchor) {
