...
import { A as Arrow, f as fade, d as fly, h as scale, i as slide, s as send, r as receive, a as slideInBounce, b as slideDirection, q as quintOut } from './Arrow.10017e79.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		i: function intro(local) {
			...
			if (!div4_intro) {
				add_render_callback(() => {
					div4_intro = create_in_transition(div4, slide, { delay: loadDelay + 1000 });
					div4_intro.start();
				});
			}
