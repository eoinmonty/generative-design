...
import { c as cubicOut, A as Arrow, s as send, r as receive, a as slideInBounce, b as slideDirection, f as fade, d as fly, e as slide, g as elasticOut, h as backOut } from './Arrow.bcc14a15.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div2, file, 78, 4, 1639);
			...
			add_location(div3, file, 82, 1, 1728);
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -500, delay: 400 }, true);
		...
		o: function outro(local) {
			...
			if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -500, delay: 400 }, false);
