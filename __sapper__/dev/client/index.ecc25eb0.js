...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		i: function intro(local) {
			...
			if (!div4_intro) {
				add_render_callback(() => {
					div4_intro = create_in_transition(div4, slide, { delay: loadDelay * 2.5 });
					div4_intro.start();
				});
			}
			...
			if (!div5_intro) {
				add_render_callback(() => {
					div5_intro = create_in_transition(div5, slide, { delay: loadDelay * 2.5 });
					div5_intro.start();
				});
			}
			...
			if (!div6_intro) {
				add_render_callback(() => {
					div6_intro = create_in_transition(div6, slide, { delay: loadDelay * 2.5 });
					div6_intro.start();
				});
			}
			...
			if (!div7_intro) {
				add_render_callback(() => {
					div7_intro = create_in_transition(div7, slide, { delay: loadDelay * 2.5 });
					div7_intro.start();
				});
			}

			add_render_callback(() => {
				if (!div8_transition) div8_transition = create_bidirectional_transition(
					div8,
					scale,
					{
						duration: 500,
