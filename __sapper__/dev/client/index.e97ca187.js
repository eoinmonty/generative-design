...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div1, "class", "background-container-right");
			add_location(div1, file$1, 80, 1, 1664);
			attr_dev(div2, "class", "background svelte-e4b2ce");
			add_location(div2, file$1, 72, 0, 1415);
			attr_dev(div3, "class", "arrow");
			add_location(div3, file$1, 86, 2, 1854);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-e4b2ce");
			add_location(a, file$1, 85, 1, 1746);
			attr_dev(div4, "class", "p5-container-top-left svelte-e4b2ce");
			add_location(div4, file$1, 90, 2, 1938);
			attr_dev(div5, "class", "p5-container-top-right svelte-e4b2ce");
			add_location(div5, file$1, 93, 2, 2002);
			attr_dev(div6, "class", "p5-container-bottom-left svelte-e4b2ce");
			add_location(div6, file$1, 96, 2, 2067);
			attr_dev(div7, "class", "p5-container-bottom-right svelte-e4b2ce");
			add_location(div7, file$1, 99, 2, 2134);
			attr_dev(div8, "class", "contents svelte-e4b2ce");
			add_location(div8, file$1, 84, 0, 1722);
		},
		m: function mount(target, anchor) {
