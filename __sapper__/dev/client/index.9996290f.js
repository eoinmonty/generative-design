...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "background-container-left svelte-z6cvyd");
			add_location(div0, file$1, 81, 1, 1660);
			attr_dev(div1, "class", "arrow");
			add_location(div1, file$1, 88, 2, 1984);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "svelte-z6cvyd");
			add_location(a, file$1, 87, 1, 1876);
			attr_dev(div2, "class", "p5-container-top-left svelte-z6cvyd");
			add_location(div2, file$1, 93, 4, 2101);
			attr_dev(div3, "class", "p5-container-top-right svelte-z6cvyd");
			add_location(div3, file$1, 96, 4, 2171);
			attr_dev(div4, "class", "p5-container-bottom-left svelte-z6cvyd");
			add_location(div4, file$1, 99, 4, 2242);
			attr_dev(div5, "class", "p5-container-bottom-right svelte-z6cvyd");
			add_location(div5, file$1, 102, 4, 2315);
			attr_dev(div6, "class", "p5-containers svelte-z6cvyd");
			add_location(div6, file$1, 92, 2, 2069);
			attr_dev(div7, "class", "background-container-right svelte-z6cvyd");
			add_location(div7, file$1, 106, 2, 2396);
			attr_dev(div8, "class", "contents svelte-z6cvyd");
			add_location(div8, file$1, 80, 0, 1636);
		},
		m: function mount(target, anchor) {
